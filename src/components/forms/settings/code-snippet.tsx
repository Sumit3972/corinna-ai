...
const snippet = `
    ...
    iframe.src = "https://corinna-k0ir0xdet-sumit-mehtas-projects.vercel.app/"
    iframe.classList.add('chat-frame')
    document.body.appendChild(iframe)
    
    window.addEventListener("message", (e) => {
        if(e.origin !== "https://corinna-k0ir0xdet-sumit-mehtas-projects.vercel.app") return null
        let dimensions = JSON.parse(e.data)
        iframe.width = dimensions.width
        iframe.height = dimensions.height
        iframe.contentWindow.postMessage("${id}", "https://corinna-k0ir0xdet-sumit-mehtas-projects.vercel.app/")
    })
`
